...
class mainProgram:
    ...
    def shichang(self,name,wlkcID,wlkckkID,zjid):
        ...
        response = requests.get('http://jxjy.stdu.edu.cn/student/BootStrap_PPT.aspx', params=params, headers=headers, verify=False)
        ...
        guowangdaqingqiu=requests.post('http://jxjy.stdu.edu.cn/student/BootStrap_PPT.aspx',params=params,headers=headers2,data=data2,verify=False)
        ...
        if viewstate_match and eventvalidation_match:
            ...
            print("未找到__VIEWSTATE或__EVENTVALIDATION元素")
        ...
        time.sleep(70)
        guowangjieshu=requests.post('http://jxjy.stdu.edu.cn/student/BootStrap_PPT.aspx',params=params,headers=headers2,data=data3,verify=False)
    ...
    def chapterList(self):
        ...
        response = requests.get('http://jxjy.stdu.edu.cn/student/BootStrap_CourseIndex.aspx', params=params, headers=headers, verify=False)
